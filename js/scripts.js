$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Preetha and John's Wedding",

            // Event start date
            start: new Date('Sept 07, 2019 16:00'),
            ...
            end: new Date('Sept 07, 2019 22:00'),

            // Event Address
            address: 'Glenview Mansion, Rockville, MD',
...
function initBBSRMap() {
    var la_fiesta = {lat: 39.086544, lng: -77.129280};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
